/**
 * DOM APIs Maintains Utilities. Copyright (c) Allex Wang
 *
...
export const contains: <T extends Element>(a: T, b: T | null) => boolean =
  docElem.compareDocumentPosition || docElem.contains
    ? (a, b) => {
